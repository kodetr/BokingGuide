...
public class UploadVidioGuideActivity extends AppCompatActivity {
    ...
    public UploadVidioGuideActivity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Tambah Vidio Guide");
...
//        File file = FileUtils.getFile(this, selectedImageUri);
        ...
        Call<ResponseBody> call = nService.upload_vidio(getIntent().getIntExtra("id", 0), photo);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    Toast.makeText(UploadVidioGuideActivity.this, "Berhasil diupload", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(UploadVidioGuideActivity.this, "Gagal diupload", Toast.LENGTH_SHORT).show();
                }
            }
