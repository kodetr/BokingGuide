...
public class AddWisatawanActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    prgDialog.dismiss();
                    Toast.makeText(AddWisatawanActivity.this, getString(R.string.simpan_berhasil), Toast.LENGTH_LONG).show();
                } else {
                    prgDialog.dismiss();
