...
public class UploadDestinasiActivity extends AppCompatActivity {
    ...
    public UploadDestinasiActivity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Ganti Foto Destinasi");
    ...
    private void uploadFoto() {
        prgDialog = ProgressDialog.show(UploadDestinasiActivity.this, "Proses Data", "Tunggu sebentar..!", false, false);
        prgDialog.show();
        ...
        Call<ResponseBody> call = nService.upload_foto_destinasi(getIntent().getIntExtra("id", 0), photo);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    Toast.makeText(UploadDestinasiActivity.this, "Berhasil diubah", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(UploadDestinasiActivity.this, "Gagal diubah", Toast.LENGTH_SHORT).show();
                }
            }
